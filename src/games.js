export const games = [
  ...
  {id:'nyan',path:'/games/nyan-sort/',name:'にゃんそーと',lead:'注いでそろえる 猫のパズル',description:'猫の液体をボトルからボトルへ。 同じ色でいっぱいにしよう！ 見た目はのんびり、注ぐ順番はよく考えて。',extra:'いつもの色分けに加えて、曜日で変わるデイリーパズルも。 いろんなボトルとねこたちが待っています。',facts:['色分けパズル','デイリーパズル','無料'],url:'https://nyan-sort.ver1000000.com/',cta:'にゃんそーとで遊ぶ',cat:'nyan-cat.png'},
  {id:'tower',name:'キャットタワーはどこまでも',preview:true},
  {id:'future',name:'次のゲーム',preview:true}
];

export const site = {name:'Mico mico nekochan games',origin:'https://mcmcnkcn.github.io',description:'ﾓﾁﾓﾁﾈｺﾁｬﾝ、にゃんそーと。 ブラウザで遊べる、ねこのゲームを作っています。'};
